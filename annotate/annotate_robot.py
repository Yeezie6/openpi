...
def main():
    ...
    OUTPUT_DIR = "/mnt/pfs/scalelab/yiqing/openpi/annotate/naive_1_annot_result"
    OUTPUT_FILE = "/mnt/pfs/scalelab/yiqing/openpi/annotate/naive_1_annot_result/annotations_robot_naive_1.json"
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    ...
    DATASET_PATH = "/mnt/pfs/scalelab/yiqing/openpi/PickPlaceBottle/PickPlaceBottle_Merged_v4/videos/chunk-000/observation.camera_0.rgb"
    
    
    # Load additional info txt and pass to pipeline
    ADDITIONAL_INFO_TXT = "/mnt/pfs/scalelab/yiqing/openpi/annotate/video_naive_grasptype.txt"
    additional_info_map = {}
